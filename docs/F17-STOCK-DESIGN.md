...
- รายงานเดือนที่ยังไม่มีรอบนับเต็ม lock → **ขึ้นแบนเนอร์เตือนเด่น** "ตัวเลขยังไม่ยืนยันกับของจริง"
  (implement จริงเลือกแบนเนอร์แทน hard-block — finance ต้องดู preview ระหว่างเดือนได้)
